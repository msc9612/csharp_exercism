...
def score(touching_power_pellet, touching_dot):
    ...
    """
    if touching_dot == True or touching_power_pellet == True or touching_power_pellet == True and touching_dot == True:
        return True
    else:
        return False
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    if has_eaten_all_dots == True and touching_ghost == True and power_pellet_active == False:
        return False
        ...
        return True
    elif  has_eaten_all_dots == True and power_pellet_active == True:
        return True
    else:
        return False
